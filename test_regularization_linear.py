...
class TestRegularizationLinear(TestCase):
    def test_call(self):
        ...
        my_estimator = MyLinearRegression(n_epochs=1000)
        my_estimator.fit(X_train, y_train)
        print(my_estimator.w)

        myl2_estimator = MyLinearRegression(n_epochs=1000, l2=0.01)
